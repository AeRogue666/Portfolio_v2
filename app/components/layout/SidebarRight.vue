...
<template>
    <USlideover v-model:open="isOpen" :title="t('sidebar-right.title')" :description="t('sidebar-right.description')"
        :ui="{
            content: 'bg-(--bg)',
        ...
        <IconButton id="button-sidebarright" :variant="'ghost'" :color="'neutral'" icon="fa7-solid:gear"
            :size="'size-10'" :label="isOpen ? $t('sidebar-right.open') : t('sidebar-right.close')" :class="'size-10'"
