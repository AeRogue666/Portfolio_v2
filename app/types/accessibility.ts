...
interface AccessibilityReportTranslation {
  // Résumé
  title: string;
  description: string;
...
export interface AccessibilityReport {
  translations: Record<Locale, AccessibilityReportTranslation>;
}

export type AccessibilityReportResponse = AccessibilityReportTranslation & {
  stats: {
    total: number;
    conformes: number;
    nonConformes: number;
